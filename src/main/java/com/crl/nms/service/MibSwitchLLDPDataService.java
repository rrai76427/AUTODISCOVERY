...
/*        String cmd = new StringBuilder("snmpwalk -v3 -On -u ").append(userName).append(" -a ").
        ...
        String cmd = new StringBuilder("snmpwalk -v").append(ipRange.getSnmpVersion()).append( " -On -u ").append(ipRange.getUsernameSNMP()).append(" -a ").
...
/*        String cmd = new StringBuilder("snmpwalk -v" ).append(ipRange.getSnmpVersion()).append("c  -On -c ").append(ipRange.getUsernameSNMP()).append(" ").
